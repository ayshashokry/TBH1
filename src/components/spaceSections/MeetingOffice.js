...
export default class MeetingOffice extends Component {
  constructor(props) {
    super(props);
    this.state = {
      meetingRooms: [
        {
          src1:
            'https://tbhwebsite.s3.me-south-1.amazonaws.com/meeting+room+2.webp',
          src2:
            'https://tbhwebsitepng.s3.me-south-1.amazonaws.com/meeting+room1.png',
          alt: 'TBH office1',
          id: '1'
        },
        {
          src1:
            'https://tbhwebsite.s3.me-south-1.amazonaws.com/meeting+room.webp',
          src2:
            'https://tbhwebsitepng.s3.me-south-1.amazonaws.com/meeting+room2.png',
          alt: 'TBH office2',
          id: '2'
        }
      ]
